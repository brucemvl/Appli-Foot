...
return (
    <article>
        ...
        <div className="statistiques">
            ...
            <div className="statistiques__tirs"> <p>{passesReussies[0][0].value} ({accuracy[0][0].value})</p><span>Passes réussies</span><p>{passes[1][0].value} ({accuracy[1][0].value})</p></div>
